...
class AttachmentsControllerTest < ActionController::TestCase
  ...
  test "should create attachment" do
    assert_difference('Attachment.count') do
      post :create, attachment: { dataset_id: @attachment.dataset_id, file: @attachment.file, folder: @attachment.folder }
    end
  ...
  test "should update attachment" do
    patch :update, id: @attachment, attachment: { dataset_id: @attachment.dataset_id, file: @attachment.file, folder: @attachment.folder }
    assert_redirected_to attachment_path(assigns(:attachment))
  end
