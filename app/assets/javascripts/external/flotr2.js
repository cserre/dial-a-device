...
Flotr.defaultOptions = {
  ...
  xaxis: {
    ...
    directionReversed: false,     // false=>axis from left to right or true=> axis from right to left
  },
  x2axis: {},
  yaxis: {
    ticks: null,           // => format: either [1, 3] or [[1, 'a'], 3]
    ...
    directionReversed: false,     // false=>bottom to top , true=>top to bottom 	
  },
  y2axis: {
    titleAngle: 270
  },
...
Axis.prototype = {
  ...
  setScale : function () {
    var
      ...
      direction = options.directionReversed,
...
_.extend(Axis, {
  getAxes : function (options) {
    return {
      x:  new Axis({options: options.xaxis,  n: 1, length: this.plotWidth, orientation: 1}),
      x2: new Axis({options: options.x2axis, n: 2, length: this.plotWidth, orientation: 1}),
...
/** Lines x orientation reversed**/
Flotr.addType('revlines', {
  options: {
    show: false,           // => setting to true will show lines, false will hide
    lineWidth: 2,          // => line width in pixels
    fill: false,           // => true to fill the area from the line to the x axis, false for (transparent) no fill
